...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages = [
    ...
    { url: `${baseUrl}/servicios/bikini`, lastModified: new Date(), priority: 0.9, changeFrequency: "monthly" as const },
    ...
    { url: `${baseUrl}/servicios/piernas`, lastModified: new Date(), priority: 0.9, changeFrequency: "monthly" as const },
    { url: `${baseUrl}/servicios/facial`, lastModified: new Date(), priority: 0.88, changeFrequency: "monthly" as const },
