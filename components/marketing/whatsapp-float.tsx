...
const WA_MSG = encodeURIComponent("Hola, me interesa información sobre depilación láser en MiPiel Veracruz 😊");
...
export function WhatsAppFloat() {
  ...
  useEffect(() => {
    ...
    const p = setInterval(() => setPulse((v) => !v), 3500);
  ...
  return (
    ...
    >
      ...
      {/* Button */}
      <div className="relative w-14 h-14 bg-[#22c55e] hover:bg-[#16a34a] rounded-full shadow-[0_4px_20px_rgba(34,197,94,0.5)] flex items-center justify-center transition-all duration-200 hover:scale-110">
