        ...
        <div className="section-container relative z-10">
          <div className="nos-hero max-w-3xl mx-auto text-center">
            ...
            <h1 className="font-display text-4xl md:text-6xl font-extrabold text-gray-900 leading-tight mb-6">
              Clínica Dermocosmética en Veracruz —{" "}
              <span className="text-gradient">8 Años de Resultados Reales</span>
            </h1>
            <p className="text-gray-500 text-lg md:text-xl leading-relaxed">
              Fundamos MiPiel Centro Dermocosmético en Boca del Río con una convicción:
